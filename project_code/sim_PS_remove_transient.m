function Tave = sim_PS_remove_transient(s,Tend, replication_id , w)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Note : this function will be called for making replications.
...
% input : replication_id = for choosing different seed 

% output : save file2_running_mean_transient_7_4000 (for response time analysis)
% output : Tave = the estimated mean response time without the non-steady part
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save file2_running_mean_transient_7_4000 running_mean_transient;
